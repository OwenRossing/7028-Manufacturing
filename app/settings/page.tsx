...
export default function SettingsPage() {
  return (
    <section className="space-y-4">
      ...
      <Link href="/import">
        <Card className="clickable-surface space-y-3">
          <h2 className="text-lg font-semibold text-white">Import Tools</h2>
          <p className="text-sm text-steel-300">Upload and commit Onshape BOM imports.</p>
          <p className="text-sm font-semibold text-steel-100">Open BOM import</p>
        </Card>
      </Link>
    </section>
  );
